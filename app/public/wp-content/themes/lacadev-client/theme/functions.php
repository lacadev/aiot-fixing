 ...
 */
add_filter('lacadev/super_user_logins', function($logins) {
    return ['lacadev', 'aiot.anhd']; // Add your developer username here
});
 ...
 */
add_filter('lacadev/is_super_user', function($is_super, $current_user) {
    // Developers are always super users regardless of role
    $super_logins = apply_filters('lacadev/super_user_logins', ['lacadev', 'aiot.anhd']);
...
// =============================================================================
define('LACADEV_CLIENT_SCHEMA_VERSION', '1.0.0');
